...
function InternationalizedInput(props) {
  const parentValue = useFormValue(
    ...
    (patches) => {
      ...
      if ((valueField === void 0 || Array.isArray(valueField) && valueField.length === 0) && Array.isArray(patches) && patches.some((patch) => patch.type === "insert" && patch.path && patch.path.length > 0 ? patch.path[0] === "value" || typeof patch.path[0] == "number" : !1)) {
